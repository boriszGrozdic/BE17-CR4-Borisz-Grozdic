...
<html>
    ...
    <body>
        <fieldset>
            <legend class='h2'>Details of a Book <img class='img-thumbnail rounded-circle' src='pictures/<?php echo $picture ?>' alt="<?php echo $title ?>"></legend>
            <form action="details.php"  method="post" enctype="multipart/form-data">
                <table class="table">
                    ...
                    <tr>
                        <th>Author FN</th>
                        <td><?php echo $authorFirstName ?></td>
                    </tr>
                    <tr>
                        <th>Author LN</th>
                        <td><?php echo $authorLastName ?></td>
                    </tr>
                    <tr>
                        <th>Publisher</th>
